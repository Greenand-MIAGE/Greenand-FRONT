              ...
              <div className="col-12 text-center">
                <div className="text-white">
                  ...
                  <h5 className="mb-12 text-center">
                    Partagez vos annonces avec de multiples particuliers en
                    quête d'un monde vert et libérez cette verdure qui sommeille
                    en vous !
                  </h5>
                  <div className="py-5 "></div>
                  <a
                    className="btn btn-outline-white btn-lg mb-8"
                    href="#formCreateAnnonceId"
                  >
                    <i className="fas fa-clone left"></i> Créer une annonce{" "}
                  </a>
                </div>
              </div>
            </div>
