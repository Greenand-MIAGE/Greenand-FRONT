        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div id="multi-item-example" className="carousel slide carousel-multi-item" data-ride="carousel">
                                    ...
                                    <div className="card mb-2">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <a href="/annonce" className="text-success px-3">
                                                <h6>Découvrir l'annonce <i className="fas fa-angle-double-right"></i></h6>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="controls-top text-center btnOffre">
                        <a className="btn-floating btn-left" href="#multi-item-example" data-slide="prev"><i className="fa fa-chevron-left"></i></a>
                        <a className="btn-floating btn-right" href="#multi-item-example" data-slide="next"><i className="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
