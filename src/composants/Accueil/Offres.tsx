    ...
    <div className="mask mask_style">
      <div className="d-flex justify-content-center align-items-center h-100">
        ...
        <img
          ...
          <a className="btn btn-outline-white btn-lg mb-8" href="#partage_annonce"><i className="fas fa-clone left"></i> Voir les annonces </a>
        </div>
      </div>
    </div>
  </div>
            ...
            <h3 className="text-success text-center" id="dern_offres"> Nos dernières offres</h3>
            <div className="py-5"></div>
      ...
      <h6>Découvrir l'annonce <i className="fas fa-angle-double-right"></i></h6>
            ...
            <div className="py-5 "></div>
            <h3 className="text-success text-center">Voici les offres disponibles </h3>
            <div className="py-5 "></div>
